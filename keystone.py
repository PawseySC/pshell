...
#------------------------------------------------------------
# connect to keystone and acquire a token
# NEW - removed all updating mechanisms as ingest cluster is returning server errors for credential queries - which bombs the discovery
    def connect(self):
        self.logging.info("url=%r" % self.url)
# SSO auth - I don't like the mflux dependency
