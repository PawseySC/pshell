...
# noisy DEBUG
#		self.mf_client.print_xml(result)
...
# generic passthru
		...
		self.mf_client.print_xml(reply)
...
# ---
	def help_lf(self):
		...
		print "Usage: lf <folder> <-p page> <-s size>\n"
		print "Examples: lf /projects/my project/some directory"
		print "          lf -p 2"
		print "          lf\n"
...
# --
	def help_delegate(self):
		print "Create a delegated credential, stored in your local home directory, that will be automatically reused to authenticate to the remote server. An optional argument can be supplied to set the number of days the credential is active, or set to off to destroy all delegated credentials for your account.\n"
		print "Usage: delegate <days>\n"
